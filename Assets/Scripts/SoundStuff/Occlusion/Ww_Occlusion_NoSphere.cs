...
public class Ww_Occlusion_NoSphere : MonoBehaviour
{
    ...
    public float LoPass_Min = 0;
    public float Volume_Min = 0;
    ...
    void Update()
    {
        ...
        if (hit)
        {
            ...
            {
                AkSoundEngine.SetRTPCValue(RTPC_LoPass, LoPass_Min, gameObject);
                AkSoundEngine.SetRTPCValue(RTPC_Volume, Volume_Min, gameObject);
            }
        }
    }
}
